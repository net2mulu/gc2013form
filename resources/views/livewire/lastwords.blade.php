<div>
    ...
    <div class="uk-form-group  mb-0">
                        ...
                        <div class="uk-inline w-full">
                            ...
                            <textarea wire:model.defer="lastwordtoupdate" class="uk-input" name="" id="" cols="20" rows="10" placeholder="Type your Last word Here..."></textarea>
                        </div>
    ...
    <div class="uk-form-group  mb-0">
                        ...
                        <div class="uk-inline w-full">
                            ...
                            <textarea wire:model="lastword" class="uk-input" name="" id="" cols="20" rows="10" placeholder="Type your Last word Here..."></textarea>
                        </div>
